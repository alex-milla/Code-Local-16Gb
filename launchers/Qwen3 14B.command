#!/bin/bash
# Claude Code — Qwen3 14B (excellent long-context handling)
...
MODEL_NAME="${MLX_MODEL_LABEL:-Qwen3 14B}"

MLX_MODEL_DEFAULT="$(resolve_mlx_model \
  "$HOME/.cache/huggingface/hub/Qwen3-14B-4bit" \
...
echo "  → Great context length · Good for large codebases"
echo ""
